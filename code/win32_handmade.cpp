...
#define CompletePastReadBeforeFutureRead _ReadBarrier()
...
ThreadProc(LPVOID lpParameter)
{
	...
	for (;;)
	{
		if (NextEntryToDo < EntryCount)
		{
			...
			int EntryIndex = InterlockedIncrement((uint32 volatile *)&NextEntryToDo) - 1;
			...
			InterlockedIncrement((uint32 volatile *)&EntryCompletionCount);
		}
		else
		{
